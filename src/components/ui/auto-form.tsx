...
export type FieldConfigItem = {
  ...
  renderParent?: (props: { children: React.ReactNode }) => React.ReactElement | null | undefined;
};
...
function AutoFormDateTimePicker({
  label,
  isRequired,
  fieldConfigItem,
  fieldProps,
    ...
    <FormItem>
      ...
      <FormControl>
        <Select onValueChange={field.onChange} defaultValue={field.value}>
          <SelectTrigger>
            <SelectValue className='w-full'>{field.value ?? 'Виберіть зі списку'}</SelectValue>
          </SelectTrigger>
          <SelectContent>
            {values.map((value: any) => (
...
const INPUT_COMPONENTS = {
  ...
  date: AutoFormDate,
  datetime: AutoFormDateTimePicker,
  select: AutoFormEnum,
